    ...
    {{-- <div class="row"> --}}
        <div class="col-md-offset-3 col-md-4 text-center">
            ...
            <div class="form-login"></br>
                ...
                <div class="text-center"><a style="color: black" href="{{route('users.login')}}">Quay lại đăng nhập</a></div>
            </div>
        </div>
    {{-- </div> --}}
    </br></br></br>
